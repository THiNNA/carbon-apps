...
const DEFAULT_FACTORS_MAP: Record<string, { category: string; name: string; value: number; unit: string; source: string; sourceUrl: string }> = {
  ...
  s3TonerCartridges: { category: 'scope3', name: 'ตลับหมึกพิมพ์เลเซอร์', value: 4.8000, unit: 'kgCO2e/ตลับ', source: 'อ้างอิงทั่วไป — HP/Xerox LCA average value', sourceUrl: 'https://www.hp.com' },
  s3AlcoholMl: { category: 'scope3', name: 'ปริมาณการใช้ Alcohol', value: 0.0021, unit: 'kgCO2e/มล.', source: 'อ้างอิงทั่วไป — Ethanol GWP average (2.1 kgCO2e/L)', sourceUrl: '' },
  s3NaohKg: { category: 'scope3', name: 'โซดาไฟ NaOH', value: 1.1200, unit: 'kgCO2e/กก.', source: 'อ้างอิงทั่วไป — Chlor-alkali NaOH (50% solution)', sourceUrl: '' },
  s3AlumKg: { category: 'scope3', name: 'สารส้ม', value: 0.2000, unit: 'kgCO2e/กก.', source: 'อ้างอิงทั่วไป — Aluminum sulfate footprint', sourceUrl: '' },
  s3SulfuricAcidKg: { category: 'scope3', name: 'กรดซัลฟิวริก', value: 0.2500, unit: 'kgCO2e/กก.', source: 'อ้างอิงทั่วไป — H2SO4 production average', sourceUrl: '' },
  s3LimeKg: { category: 'scope3', name: 'ปูนขาว', value: 1.0000, unit: 'kgCO2e/กก.', source: 'อ้างอิงทั่วไป — Hydrated lime GWP', sourceUrl: '' },
  s3ChlorineKg: { category: 'scope3', name: 'คลอรีน', value: 1.0800, unit: 'kgCO2e/กก.', source: 'อ้างอิงทั่วไป — Liquid chlorine production', sourceUrl: '' },
